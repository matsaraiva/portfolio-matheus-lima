...
const outcomeIcons: Record<string, LucideIcon> = {
  ...
  "Web3 systems": WalletCards,
  "Delivery quality": BadgeCheck,
};

const companyIcons = [Gamepad2, Building2, Code2, BriefcaseBusiness];
...
const proofPoints = [
  ...
  },
  {
    ...
    description:
      "Unity client, UGS, cloud functions, wallet services, and blockchain calls connected into player-facing paths.",
  },
  {
    icon: ShieldCheck,
    label: "Validation",
    ...
    description:
      "Build checks, Android validation, QA evidence, performance fixes, and regression-focused delivery.",
  },
  {
    icon: FileText,
    label: "Handoff",
    ...
    description:
      "Architecture notes, API references, test context, and public-safe case-study material for future teams.",
  },
];
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid items-start gap-8 lg:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {["Unity", "Multiplayer", "Web3"].map((label) => (
                ...
                >
                  ...
                  <p className="mt-2 text-xs leading-5 opacity-80">Core Data2073 layer</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-lg border border-neutral-200 bg-neutral-950 shadow-2xl dark:border-white/10">
            <Image
              alt="Representative systems map for Data2073 multiplayer, LiveOps, Web3, backend, and QA work"
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-neutral-950 via-neutral-950/75 to-transparent p-5 text-white">
              ...
              <p className="mt-2 text-sm leading-6 text-neutral-100">
                Client systems, matchmaking, dedicated server, LiveOps, Web3 bridge, and QA delivery.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="group relative mt-6 overflow-hidden rounded-lg border border-neutral-200 bg-neutral-950 shadow-sm dark:border-white/10">
              ...
              <div className="absolute inset-y-0 left-0 flex max-w-sm flex-col justify-center p-5 text-white">
                ...
                <p className="mt-3 text-sm leading-6 text-neutral-100">
                  Proof that the work moves across client systems, services, cloud delivery, and product validation.
                </p>
              </div>
            </div>
